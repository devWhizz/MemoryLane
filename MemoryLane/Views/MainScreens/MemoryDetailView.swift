...
struct MemoryDetailView: View {
    ...
    // Control the visibility of the delete alert
            ...
            VStack(alignment: .leading, spacing: 16) {
                ...
                if let coverImageURL = URL(string: memory.coverImage) {
                    ...
                    ZStack(alignment: .bottom) {
                        ...
                        GoogleMapViewWithControls(memoryViewModel: memoryViewModel, address: memory.location)
    ...
    private func shareMemory() {
        memoryViewModel.shareMemory(memory)
    }
